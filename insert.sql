...
-- Usuarios
INSERT INTO
  `platziblog.usuarios` (`id`, `login`, `password`, `nickname`, `email`)
VALUES
  (
    1,
    'israel',
...
-- Categorías
INSERT INTO
  `platziblog.categorias` (`id`, `nombre_categoria`)
VALUES
  (1, 'Ciencia');
...
-- Etiquetas
INSERT INTO
  `platziblog.etiquetas` (`id`, `nombre_etiqueta`)
VALUES
  (1, 'Robótica');
...
-- Posts-etiquetas
INSERT INTO
  `platziblog.posts_etiquetas` (`id`, `post_id`, `etiqueta_id`)
VALUES
  (1, 43, 3);
